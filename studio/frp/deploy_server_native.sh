#!/bin/bash
# FRP 服务端快速部署脚本 - 纯二进制版本（无需 Docker）

set -e

echo "========================================="
echo "  FRP 服务端快速部署脚本（二进制版）"
echo "========================================="
...
ExecReload=${FRP_DIR}/frps reload -c ${FRP_DIR}/frps.ini
LimitNOFILE=1048576
...
echo "3. 访问管理仪表板：http://${SERVER_IP}:7500"
